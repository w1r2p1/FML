...
<img src='img/Turtles_all_the_Way_Down.jpeg'/>
...
<!-- --- -->
<!-- class:left -->
<!-- # Your turn: Interaction excercise -->
...
<!-- read_csv("data/creditcard.csv")->dat -->
<!-- tree <- rpart(Class~., data=dat, cp=.01) -->

<!-- ``` -->
<!-- ] -->

<!-- .panel[.panel-name[Plot] -->
<!-- ```{r plot_tree, out.height="50%"} -->
<!-- # Visualize the decision tree with rpart.plot -->
<!-- rpart.plot(tree, box.palette="RdBu", shadow.col="gray", nn=TRUE) -->
<!-- ``` -->
<!-- ] -->
<!-- .panel[.panel-name[Explain] -->

<!-- - The data is 300,000 credit card transaction, a small proportion of which are fraudulent. -->
<!-- - The major of the features are annoymised, and it is sourced from kaggle.com -->
<!-- - The data has 30 features, which equates to how many potential interactions? -->
<!-- - A naive decision tree is fitted and shows that the final depth is 5, suggesting that there are potentially interactions of order 5 which are useful in predicting fraud. -->
...
<<<<<<< HEAD
 - Opposite is a useful mental image to understand what deep learning is.
=======
>>>>>>> 487bc2730c67c76c0a00438b0f69a85b90c65226
