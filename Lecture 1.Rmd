...
- .salt[Advantages and challenges in using ML]
...
- The purpose is to introduce the emerging field of [Financial Machine Learning (FML)](https://jfds.pm-research.com/).  as a complement to traditional financial research techniques. 
...
`r tufte::quote_footer("Dixon et al., 2020")`
]
