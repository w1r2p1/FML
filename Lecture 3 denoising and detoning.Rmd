...
# Deep dive into matrices
.pull-left[
<img src=img/matrixalgebra.png, width="50%" height="50% align="middle">

- Rarrange the equality to make all terms on the right side (A is a matrix and $\lambda$ is a number so we have to an identity matrix $I$ which applies no transformation at all) to find a solution fo the eigenvalue.
...
In order to get rid of trivial solutions, we use the determinant.
]
.pull-right[
<img src="img/squareunit.png" width="25%" height="25% align="left">
<img src="img/4squnits.png" width="25%" height="25% align="right">
- The determinant is simply a measure of the factor in which area is stretched by a transformation matrix.
- In the above image, one standard square on the coordinate plan ha an area of one square unit
- When the space is stretched by a transformation matrix, the new area is four square units
