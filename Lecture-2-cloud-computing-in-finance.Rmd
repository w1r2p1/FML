...
.heat[`r fa(name="r-project")` is design as an interperable language connecting many software]
...
- Learning to integrate programming languages as a quant finance professional is part of the communicative bridge building need to close the gap between complex models and financial decisions
...
.pull-left[ 
### Steps to access your RStudio IDE in the Cloud
...
.pull-left[ 
### Steps to access your RStudio Connect in the Cloud
1. Open a web browser
2. Navigate to: http://q-rap.qub.ac.uk
3. Create an account using your <NAME>@qub.ac.uk email
4. Use a recognisable username that identifies you, for example 
]
.pull-right[ 
